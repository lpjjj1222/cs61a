...
def piggy_points(score):
    ...
    square = score*score
    min_digit = square % 10
    next_floor = square // 10
    while next_floor !=0:
        next_digit = next_floor % 10
        if next_digit < min_digit:
            min_digit = next_digit
        next_floor = next_floor // 10
    return min_digit + 3
    # END PROBLEM 2
...
def more_boar(player_score, opponent_score):
    ...
    secondleft_p = player_score % 10
    floor_div = player_score // 10
    mostleft_p = floor_div % 10
    ...
    secondleft_o = opponent_score % 10
    floor_div = opponent_score // 10
    mostleft_o = floor_div % 10
    
    if secondleft_p < secondleft_o and mostleft_p < mostleft_o:
        return True
    else:
        return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            if_more = True
            while if_more and score0 < goal and score1 < goal:
                strategy = strategy0(score0,score1)
                score0 += take_turn(strategy,score1,dice = dice, goal = goal)
                if_more = more_boar(score0,score1)
            ...
            while if_more and score0 < goal and score1 < goal:
                ...
                score1 += take_turn(strategy,score0, dice = dice, goal = goal)
                if_more = more_boar(score1,score0)
                say = say(score0,score1)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def count(score0, score1):
        if who == 0:
            ...
            score = score1
        #print('This turn, Player',who,'score',score_gain)    
        ...
        if score_gain > running_high:
            ...
            return announce_highest(who,last_score=score, running_high=score_gain)
        else:
            return announce_highest(who,last_score=score, running_high=running_high)
...
def piggypoints_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    result_0 = piggy_points(opponent_score)
    if result_0 >= cutoff:
        return 0
    else:
...
def more_boar_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    score += piggy
    if more_boar(score,opponent_score) or piggy >=cutoff:
        return 0
    else:
        return num_rolls
